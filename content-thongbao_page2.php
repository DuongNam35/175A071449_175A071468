...
<body>
            ...
            <div class="row">
                <div class="col-lg-12 col-sm-12 col-md-12">
                    <div class="title">
                        <div class="menu">
                            <ul class="menu1">
                                <li><a href="Main.html"><img style="width: 25px; height: 25px;" src="./img/home (1).png"
                                            alt=""></a>
                                </li>
                                <li>
    ...
    <main>
        ...
        $sql = "SELECT title,postcontet FROM bangtin where style='thông báo'";
        ...
        <div class="infor" style="background-color: #96bceb;">
            <div class="container">
                ...
                <div class="mess">
                    ...
                    <a href=""><img style="height: 50px; width: 50px;" src="img/icons8-facebook-messenger-96.png"
                            alt=""></a>
                </div>
    </footer>
