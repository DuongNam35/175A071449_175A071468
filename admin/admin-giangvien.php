...
<body class="app header-fixed sidebar-fixed aside-menu-fixed sidebar-lg-show">
  ...
  <div class="app-body">
    ...
    <main class="main">
      <button type="button" class="btn btn-success"><a href="themgv.php" style="color: white; text-decoration: none;">Thêm giảng viên</a></button>
      <table class="table table-striped">
        ...
        if(mysqli_num_rows($result)>0){
            ...
            <td>  <?php echo $row['htgiangvien'] ?></td>
            <td>  <?php echo $row['tuoi'] ?></td>    
            <td>
            <a href="edit-gv.php?edit=<?php echo $row['idgiangvien'] ?>">Sửa</a>
            <a href="del-gv.php?del=<?php echo $row['idgiangvien'] ?>">Xoá</a>
            </td>   
            </tr>
            <?php
    ...
    <footer class="app-footer fixed-bottom">
      <!-- Footer content here -->
      <div>
        Quản trị viên >  Quản lý Giảng viên
      </div>
    </footer>
  </div> 
